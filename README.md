...
gMock은 Google Test를 기반으로 한 C++용 Mock 프레임워크로, 실제 객체 대신 가짜(Mock) 객체를 만들어 외부 의존성을 제어하며 테스트할 수 있습니다.  
일반 테스트와 Mock 테스트를 모두 지원하며, TDD(Test-Driven Development) 환경에서 매우 유용합니다.
